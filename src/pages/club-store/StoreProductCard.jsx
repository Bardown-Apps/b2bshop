const StoreProductCard = ({ product }) => (
  <div className="border border-slate-200 rounded-xl overflow-hidden bg-white hover:shadow-lg hover:border-slate-300 transition-all duration-300 group">
    ...
    <div className="p-4">
      <p className="text-[11px] text-slate-500 font-medium mb-0.5">{product.club}</p>
