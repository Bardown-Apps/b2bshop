    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 divide-y lg:divide-y-0 lg:divide-x divide-slate-100">
      <div className="p-6 md:p-8">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xl font-bold text-slate-900">{PROFILE.accountNumber}</p>
        </div>
      </div>

      <div className="p-6 md:p-8">
        <InfoLabel icon={Building2}>Company Name</InfoLabel>
        <p className="text-xl font-bold text-slate-900 uppercase">{PROFILE.companyName}</p>
      </div>
      ...
      <div className="p-6 md:p-8 bg-slate-50/50">
        ...
        {RECENT_ORDERS.length > 0 ? (
          <div className="space-y-3">
            ...
            <button className="w-full mt-2 py-2.5 px-4 bg-white border border-slate-200 text-slate-700 text-sm font-semibold rounded-xl hover:bg-slate-50 transition-colors flex items-center justify-center gap-2 cursor-pointer">
